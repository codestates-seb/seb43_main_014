...
//    }
//    public static CvResponseDto.Post getCvPost() {
//        CvResponseDto.Post post = new CvResponseDto.Post();
//        post.setUserId(1L);
//        post.setName("홍길동");
//        post.setTitle("제목");
...
//    }
//
//    public static CvResponseDto.Patch getCvPatch(){
//        CvResponseDto.Patch patch = new CvResponseDto.Patch();
//        patch.setCvId(1L);
//        patch.setName("유성영");
...
//    }
//
//    public static CvResponseDto.Response getCvPatchResponse(){
//        CvResponseDto.Response response = new CvResponseDto.Response();
//        response.setCvId(1L);
...
//    }
//
//    public static CvResponseDto.Response getCvResponse() {
//        CvResponseDto.Response response = new CvResponseDto.Response();
//        response.setCvId(1L);
//        response.setUserId(1L);
