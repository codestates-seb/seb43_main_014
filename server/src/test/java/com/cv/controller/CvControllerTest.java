...
//                                        fieldWithPath("links").type(JsonFieldType.ARRAY).description("이력서에 작성할 개인 사이트(깃허브, 블로그 등) 리스트")
    ...
    @Test
        ...
        // given
        CvDto.Post post = StubDataForCv.getCvPost();
        CvDto.Patch patch = StubDataForCv.getCvPatch();
        CvDto.Response response = StubDataForCv.getCvPatchResponse();
        ...
        given(mapper.cvPatchToCv(Mockito.any(CvDto.Patch.class)))
                .willReturn(new Cv());
