...
//        CvResponseDto.Response response = StubDataForCv.getCvResponse();
//        String content = gson.toJson(post);
//
//        given(mapper.cvPostToCv(Mockito.any(CvResponseDto.Post.class)))
//                .willReturn(new Cv());
//
...
//        // given
//        CvResponseDto.Post post = StubDataForCv.getCvPost();
//        CvResponseDto.Patch patch = StubDataForCv.getCvPatch();
//        CvResponseDto.Response response = StubDataForCv.getCvPatchResponse();
...
//                .willReturn(new Cv());
//
//        given(mapper.cvPatchToCv(Mockito.any(CvResponseDto.Patch.class)))
//                .willReturn(new Cv());
//
//        given(cvService.updateCv(Mockito.any(Cv.class)))
//                .willReturn(new Cv());
//
//        given(mapper.cvToCvResponse(Mockito.any(Cv.class)))
//                .willReturn(response);
//
//        URI uri = UriComponentsBuilder.newInstance().path("/cv/edit/{cv-id}").buildAndExpand(1).toUri();
//
//        // when
//        ResultActions patchActions =
//                mockMvc.perform(RestDocumentationRequestBuilders.patch("/cv/edit/{cvId}", 1)
//                                .with(csrf())
//                                .accept(MediaType.APPLICATION_JSON)
//                                .contentType(MediaType.APPLICATION_JSON)
...
//                .andExpect(jsonPath("$.birthDay").value(patch.getBirthDay()))
//                .andExpect(jsonPath("$.birthMonth").value(patch.getBirthMonth()))
//                .andExpect(jsonPath("$.birthYear").value(patch.getBirthYear()))
//                .andExpect(jsonPath("$.selfIntroduction").value(patch.getSelfIntroduction()))
//                .andExpect(jsonPath("$.developmentJob").value(patch.getDevelopmentJob()))
//                .andExpect(jsonPath("$.cvSkillStacks[0].skillStackId").value(patch.getCvSkillStacks().get(0).getSkillStackId()))
//                .andExpect(jsonPath("$.cvSkillStacks[1].skillStackId").value(patch.getCvSkillStacks().get(1).getSkillStackId()))
//                .andExpect(jsonPath("$.educations[0].description").value(patch.getEducations().get(0).getDescription()))
//                .andExpect(jsonPath("$.careers[0].description").value(patch.getCareers().get(0).getDescription()))
//                .andExpect(jsonPath("$.customSections[0].customContent").value(patch.getCustomSections().get(0).getCustomContent()))
//                .andExpect(jsonPath("$.projects[0].description").value(patch.getProjects().get(0).getDescription()))
//                .andExpect(jsonPath("$.links[0].linkAddress").value(patch.getLinks().get(0).getLinkAddress()))
//                .andDo(document("patch-cv",
//                        getRequestPreProcessor(),
//                        getResponsePreProcessor(),
